            ...
            >
                ...
                >
                    <div className="w-full  text-center lg:text-left ">
                        ...
                        >
                            ...
                            <p className="mt-1.5 mx-auto lg:ml-0 leading-normal text-foreground-accent text-sm lg:text-base">
                                {description}
                            </p>
                        </motion.div>
                ...
                <div className={clsx("mt-5 lg:mt-0", { "lg:order-2": imageAtRight })}>
                    <div className={clsx("w-fit flex", { "justify-start": imageAtRight, "justify-end": !imageAtRight })}>
                        <Image src={imageSrc} alt="title" width={650} height={1300} quality={100} className="lg:ml-0" />
                    </div>
                </div>
            </motion.div>
        </section>
