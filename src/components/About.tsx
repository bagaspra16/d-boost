                ...
                <div className="relative z-10 max-w-6xl mx-auto">
                    ...
                    >
                        <div className="flex items-center justify-between mb-8">
                            <h3 className="text-3xl font-bold tracking-tight">{a.visionTitle}</h3>
                    ...
                    >
                        <div className="flex items-center justify-between mb-8">
                            <h3 className="text-3xl font-bold text-foreground tracking-tight">{a.missionTitle}</h3>
